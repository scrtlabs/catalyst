...
ALPHA_WARNING_MESSAGE = 'Catalyst is currently in ALPHA. It is going through ' \
                        'rapid development and it is subject to errors. ' \
                        'Please use carefully. We encourage you to report ' \
                        'any issue on GitHub: ' \
